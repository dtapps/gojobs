...
type TaskLog struct {
	...
	LogTime          time.Time `gorm:"autoCreateTime;comment:【日志】时间" json:"log_time"`                      // 【日志】时间
	TaskID           uint      `gorm:"index;comment:【任务】编号" json:"task_id"`                                // 【任务】编号
	TaskRunID        string    `gorm:"comment:【任务】执行编号" json:"task_run_id"`                                // 【任务】执行编号
	TaskResultStatus string    `gorm:"index;comment:【任务】执行状态" json:"task_result_status"`                   // 【任务】执行状态
