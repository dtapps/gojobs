...
type TaskLog struct {
	...
	SystemInsideIp  string    `gorm:"type:inet;default:0.0.0.0;comment:内网ip" json:"system_inside_ip"`  // 内网ip
	...
	SystemOutsideIp string    `gorm:"type:inet;default:0.0.0.0;comment:外网ip" json:"system_outside_ip"` // 外网ip
